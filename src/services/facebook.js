...
var Facebook = function(facebookKey, facebookSecret){
    ...
    var getImage = function(userKey, done){
        ...
        oauth.get('https://graph.facebook.com/v2.6/me/picture?redirect=false&type=large',userKey,
    ...
    var getFriends = function(userKey, done){
        ...
        oauth.get('https://graph.facebook.com/v2.6/me/friends?redirect=false',userKey,
            function(err, results,res){
                results = JSON.parse(results);
